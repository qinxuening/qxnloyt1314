...
CREATE TABLE `oubao_product_field` (  `aid` mediumint(8) unsigned NOT NULL DEFAULT '0',  `body` mediumtext NOT NULL,  `android` char(255) DEFAULT NULL,  `apple` char(255) DEFAULT NULL,  `version` varchar(255) DEFAULT NULL,  `size` varchar(255) DEFAULT NULL,  `system` varchar(255) DEFAULT NULL,  `androidcode` char(255) DEFAULT NULL,  `applecode` char(255) DEFAULT NULL,  `versionCode` varchar(255) DEFAULT NULL,  `versionName` varchar(255) DEFAULT NULL,  `minversionCode` varchar(255) DEFAULT NULL,  `about` varchar(500) DEFAULT NULL,  PRIMARY KEY (`aid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8
...
INSERT INTO `oubao_admin_user` VALUES('1','admin','cae9d9886ba25c98190fdc73dc37568d','真实姓名','邮箱','电话','1','1','')
...
INSERT INTO `oubao_fields` VALUES('34','product','版本号','versionCode','varchar','255','','0','1','1','1','|25|','','300','80')
INSERT INTO `oubao_fields` VALUES('35','product','版本名称','versionName','varchar','255','','0','1','1','1','|25|','','300','80')
INSERT INTO `oubao_fields` VALUES('36','product','允许最低版本','minversionCode','varchar','255','','0','1','1','1','|25|','','300','80')
INSERT INTO `oubao_fields` VALUES('37','product','更新介绍','about','varchar','500','','0','1','1','1','|25|','','300','150')
...
INSERT INTO `oubao_product` VALUES('21','25','0','1','安卓','','','','','','1405404540','0','40','','','0','0.00','0','0','0','0.00','','','admin','0')
INSERT INTO `oubao_product_field` VALUES('21','','/uploads/2014/07/151412006616.apk','','1.9','','','','','','','','')
