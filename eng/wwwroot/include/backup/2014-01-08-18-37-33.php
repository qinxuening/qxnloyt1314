...
CREATE TABLE `oubao_labelcus` (  `id` smallint(5) NOT NULL auto_increment,  `name` char(50) NOT NULL,  `body` text NOT NULL,  `type` tinyint(1) NOT NULL default '1',  PRIMARY KEY  (`id`)) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8
...
INSERT INTO `oubao_product` VALUES('20','25','0','1','e-home','','','','','','1388990460','0','0','','','0','0.00','0','0','0','0.00','','e-home','admin','0')
