...
CREATE TABLE `oubao_labelcus` (  `id` smallint(5) NOT NULL auto_increment,  `name` char(50) NOT NULL,  `body` text NOT NULL,  `type` tinyint(1) NOT NULL default '1',  PRIMARY KEY  (`id`)) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8
...
INSERT INTO `oubao_classtype` VALUES('33','goods','0','产品展示','','','产品展示','','','2','list_index.html','list.html','list_image.html','list_body.html','content.html','20','','','0','0','0','','1','322','223','')
INSERT INTO `oubao_classtype` VALUES('34','article','0','最新动态','','','最新动态','','','1','list_index.html','list.html','list_image.html','list_body.html','article.html','20','','','0','0','0','','1','0','0','')
...
INSERT INTO `oubao_fields` VALUES('36','product','允许最低版本','minversionCode','varchar','255','','0','1','1','1','|25|','','300','80')
...
INSERT INTO `oubao_fields` VALUES('39','goods','缩略图','simg','files','0','','0','1','1','1','|33|','','322','223')
INSERT INTO `oubao_fields` VALUES('40','goods','型号','xinghao','varchar','255','','0','1','1','1','|33|','','300','80')
INSERT INTO `oubao_fields` VALUES('41','goods','详细大图','bsimg','files','0','','0','1','0','1','|33|','','595','334')
INSERT INTO `oubao_fields` VALUES('42','goods','功能特点','tedian','varchar','500','','0','1','0','1','|33|','','300','300')
INSERT INTO `oubao_fields` VALUES('43','goods','产品参数','canshu','varchar','500','','0','1','0','1','|33|','','300','300')
INSERT INTO `oubao_fields` VALUES('44','goods','产品概况','gaikuang','text','0','','0','1','0','1','|33|','','670','300')
INSERT INTO `oubao_fields` VALUES('45','goods','安装说明','shuoming','text','0','','0','1','0','1','','','670','300')
INSERT INTO `oubao_fields` VALUES('46','goods','设备配置','peizhi','text','0','','0','1','0','1','','','670','300')
INSERT INTO `oubao_fields` VALUES('47','goods','学习功能','gongneng','text','0','','0','1','0','1','','','670','300')
INSERT INTO `oubao_fields` VALUES('48','goods','更多设置','shezhi','text','0','','0','1','0','1','','','670','300')
INSERT INTO `oubao_fields` VALUES('49','goods','常见问题解决','jiejue','text','0','','0','1','0','1','','','670','300')
...
INSERT INTO `oubao_labelcus` VALUES('8','允许最低版本','1','1')
...
INSERT INTO `oubao_product_field` VALUES('21','','/uploads/2014/10/131525304361.apk','','6','9.61M','Android2.2以上','','','V1.0.0.6','1','<info>1.优化UI效果</info>\r\n<info>2.修复切换摄像机界面闪退问题</info>','O-Home')
