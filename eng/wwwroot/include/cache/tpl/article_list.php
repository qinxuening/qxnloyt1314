...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <link rel="stylesheet" href="skin/css/solution.css">
</head>
<body>
...
<div class="solution">
    <div class="container">
           <div class="row">
            <div class="head">
                <h1>The Most Available And Intelligent Solutions</h1>
            </div>
            <div class="solution-list col-xs-12">
                <ul>
                	<?php foreach( $lists as $v){ ?>
                    <li><a href="javascript:void(0);"><img src="<?php echo $v['litpic'] ?>" alt=""><h4><?php echo $v['title'] ?></h4><p><?php echo $v['description'] ?></p></a></li>
					<?php } ?>
                </ul>
            </div>
        </div>
...
<div style="clear:both;"></div>
<div class="pic">
    <img src="skin/img/solution_pic.png" alt="">
</div>
<div style="clear:both"></div>
